...
window.EPCOPY_ES = {
  ...
  "bill.reveal": "Cerca de {annual} al año una vez que corregimos por una factura de {season} en {stateName}. Así se compone esa factura.",
  "bill.products": "Tres productos en una página. Dos de ellos se pueden negociar.",
  ...
  /* ---------- costo de esperar ---------- */
    "opener.h": "Su factura eléctrica son tres productos en una página.",
  "opener.p": "Suministro, entrega y demanda. Dos normalmente se pueden negociar, y el tercero lo fija el equipo que usted ya tiene. Cuatro toques y le mostramos cuál es cuál, y cuánto le está costando.",
