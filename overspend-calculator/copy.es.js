...
window.EPCOPY_ES = {
  ...
  "cash.lede": "El trabajo sencillo normalmente se paga solo en menos de un año. El programa completo se dimensiona para pagarse en unos dos. Financiado, el pago queda por debajo del ahorro mientras corre, y después de liquidarlo todo el monto es suyo.",
  "cash.line": "El extremo bajo de su sobrecosto es cerca de {floor} al mes. Dos años de eso es un programa de cerca de {program}. Financiado a {years} años, el pago es cerca de {payment} al mes, lo que deja cerca de {keep} al mes en su bolsillo mientras corre y los {floor} completos al mes después.",
  "cash.today": "Hoy",
  ...
  "cash.note": "Esta ilustración supone un programa dimensionado en unos dos años de ahorro, financiado a {years} años. Los términos reales varían según el historial crediticio.",
  ...
  "how.optional": "Líneas opcionales. Active las que apliquen a este edificio y el número se actualiza.",
  "how.on": "Activa",
  "how.off": "Inactiva",
