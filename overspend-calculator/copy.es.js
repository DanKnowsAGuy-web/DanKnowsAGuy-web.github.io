...
window.EPCOPY_ES = {
  ...
  "contact.fallback": "O envíenos un texto al {phone}. Aquí está el mensaje, listo para pegar:",
  "contact.sms": "Hola, soy {name}. Hice la lectura de sobrecosto para mi {facility} en {stateName}. Muestra cerca de {range} al año. ¿Qué necesitaría de mí para ver si es real? {link}",
